...
import { IpadSidebar } from "@/components/ipad-sidebar";
...
function RootNavigator() {
  ...
  return (
    <>
      ...
      {/* Website-Layout: feste Sidebar links (nur angemeldet) + Inhalt rechts */}
      <View style={{ flex: 1, flexDirection: "row", backgroundColor: colors.bg }}>
        {session ? <IpadSidebar /> : null}
        <View style={{ flex: 1 }}>
          <Stack
            screenOptions={{
          ...
          >
            ...
            <Stack.Protected guard={!!session}>
              ...
              <Stack.Screen name="theorie" options={{ headerShown: false }} />
              <Stack.Screen name="rechnungen" options={{ headerShown: false }} />
