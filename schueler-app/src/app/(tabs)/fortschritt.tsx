...
import { Badge, IconKachel, ProgressBar, Ueberschrift } from "@/components/ui";
...
export default function FortschrittScreen() {
  ...
  function neu() {
    return Promise.all([schueler.refresh(), stunden.refresh(), pruefungen.refresh()]);
  }

  return (
    <KopfSeite onRefresh={neu} kopf={<GradientKopf titel="Fortschritt" untertitel={`Führerschein Klasse ${klasse}`} unten={space(16)} />}>
