...
import { IconKachel, Screen, Ueberschrift } from "@/components/ui";
import { GradientKopf, SchulMarke } from "@/components/kopf";
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ fontSize: 13, color: colors.textMuted, marginTop: 2 }}>
                {offen > 0 ? "Tippe, um die Rechnungen zu sehen" : "Danke – keine offenen Rechnungen"}
              </Text>
            </View>
