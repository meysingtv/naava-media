...
/** Popover v3: 10-px-Radius, kein Rahmen, Popover-Ebene über Sheet und Dialog. */
...
>(({ className, align = "start", sideOffset = 6, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      className={cn(
        "z-popover w-64 rounded-lg bg-popover p-2 text-popover-foreground shadow-md outline-none",
