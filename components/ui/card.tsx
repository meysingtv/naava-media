...
/**
 * Panel v2: weiße Fläche auf der Off-White-Arbeitsfläche, 1-px-Haarlinie,
 * 10-px-Radius, kein Schatten. Kopf als schmale Titelzeile.
 */
...
const CardTitle = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("text-[13px] font-semibold leading-5 text-foreground", className)} {...props} />
  ),
);
