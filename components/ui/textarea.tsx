...
/** Textfeld v4: gleiche Optik wie das Eingabefeld, Mindesthöhe 96 px, vertikal skalierbar. */
...
>(({ className, ...props }, ref) => {
  return (
    <textarea
      className={cn(
        "flex min-h-[96px] w-full resize-y rounded-md border border-input bg-card px-3 py-2 text-sm leading-5 text-foreground shadow-xs transition-[border-color,box-shadow] duration-fast ease-soft",
