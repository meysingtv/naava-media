...
const FELD =
  "h-12 w-full rounded-[12px] border-2 border-line bg-white px-3.5 text-[15px] text-ink placeholder:text-ink-muted/70 focus:border-brand focus:outline-none focus:ring-4 focus:ring-brand/15 disabled:opacity-60";
  ...
  return (
    <form onSubmit={onSubmit} noValidate className="grid gap-4">
      ...
      {status === "error" && serverError && (
        <div className="flex items-center gap-2 rounded-[12px] bg-[#D23F3F]/10 px-3.5 py-2.5 text-[14px] font-semibold text-[#D23F3F]">
