  ...
  return (
    <section className="py-16 md:py-20">
      <Container className="max-w-3xl">
        ...
        <div className="mt-6 flex items-start gap-3 rounded-[12px] border border-[#C27C0E]/30 bg-[#C27C0E]/8 px-4 py-3 text-[14px] text-[#8a5a08]">
        ...
        <div className="mt-8 grid gap-5 text-[16px] leading-relaxed text-ink-muted [&_h2]:mt-6 [&_h2]:font-display [&_h2]:text-[20px] [&_h2]:font-bold [&_h2]:text-ink [&_strong]:text-ink">
          {children}
        </div>
      </Container>
    </section>
