...
import { cn } from "@/components/marketing/ui";
...
export function BrowserFrame({ url, children, className }: { url: string; children: React.ReactNode; className?: string }) {
  return (
    <div className={cn("overflow-hidden rounded-[16px] border border-line bg-white shadow-card", className)}>
      <div className="flex h-9 items-center gap-1.5 border-b border-line bg-paper px-3.5">
        ...
        <span className="h-2.5 w-2.5 rounded-full bg-line2" />
        <span className="h-2.5 w-2.5 rounded-full bg-line2" />
        <span className="ml-3 flex h-5 flex-1 items-center rounded-md border border-line bg-white px-2.5 text-[11px] text-ink-muted">{url}</span>
      </div>
      {children}
    </div>
  );
  ...
  return (
    <div className="bg-white p-4">
      <div className="flex items-center gap-2 border-b border-line pb-2.5">
        ...
        <span className="text-[11px] text-ink-muted">KI · Beta</span>
      </div>
      <div className="mt-3 space-y-3">
        <div className="flex justify-end">
          <div className="max-w-[85%] rounded-[16px] bg-mint px-3 py-2 text-[12.5px] text-white">
        ...
        <div className="flex gap-2">
          ...
          <div>
            <div className="max-w-[92%] whitespace-pre-line rounded-[16px] bg-paper px-3 py-2 text-[12.5px]">
