...
import { Btn, Check, Container, TextLink } from "@/components/marketing/ui";
    ...
    <section className="py-20 md:py-24">
      <Container className="grid items-center gap-12 md:grid-cols-2 md:gap-16">
        ...
        <div data-reveal data-delay="90ms" className="relative">
          ...
          <div className="absolute -bottom-6 -left-4 rounded-[16px] bg-white p-4 shadow-lift sm:-left-8">
