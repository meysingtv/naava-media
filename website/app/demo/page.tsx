...
import { Check, Container, Eyebrow } from "@/components/ui";
    ...
    <section className="relative overflow-hidden bg-brand-light/60 py-14 md:py-20">
      ...
      <Container className="relative grid gap-12 md:grid-cols-[1fr_1.05fr] md:gap-16">
        <div>
            ...
            {SCHRITTE.map((s, i) => (
              <li key={s.t} className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="text-[14.5px] text-muted">{s.d}</div>
                </div>
              </li>
            ))}
          </ol>
          ...
          <div className="mt-9 flex items-center gap-3 rounded-2xl bg-white p-4 shadow-card">
