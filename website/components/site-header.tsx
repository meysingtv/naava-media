      ...
      <header className={cn("sticky top-0 z-50 bg-white transition-shadow duration-200", scrolled || open ? "shadow-[0_8px_30px_-18px_rgba(15,26,21,.35)]" : "border-b border-line")}>
        <div className="mx-auto flex h-[72px] max-w-wrap items-center gap-6 px-5 sm:px-8">
          ...
          <div className="ml-auto hidden items-center gap-3 lg:flex">
            <Link href="/#" className="rounded-full border-2 border-line px-5 py-2.5 text-[14.5px] font-bold text-ink transition-colors hover:border-ink">
              Login
            </Link>
          ...
          <button
            className="ml-auto grid h-11 w-11 place-items-center rounded-xl border-2 border-line lg:hidden"
          ...
          <div className="border-t border-line bg-white lg:hidden">
            <nav className="flex flex-col px-5 py-2">
              ...
              <div className="flex gap-3 py-5">
                <Link href="/#" onClick={() => setOpen(false)} className="flex h-12 flex-1 items-center justify-center rounded-full border-2 border-line font-bold">
                  Login
                </Link>
